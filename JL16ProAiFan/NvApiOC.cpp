...
void NvApiSetCoreMemoryOC(int CoreClockOffset, int MemoryClockOffset) // Offset MHZ
{
	...
	if (NvApiLoad() == 0)
	{
		...
		if (CoreClockOffset >= 0 && CoreClockOffset <= 250) // 0-250
			NvApiSetCoreClockOffset(1, 0, CoreClockOffset * 1000);  //i*1000

		if (MemoryClockOffset >= 0 && MemoryClockOffset <= 1000) // 0-1000
			NvApiSetMemoryClockOffset(1, 0, MemoryClockOffset * 1000);//i*1000

		//NvApiSetCoreClockOffset(1, 0, 0);
		//NvApiSetMemoryClockOffset(1, 0, 0);
...
void NvApiSetCoreOC(int CoreClockOffset) // Offset MHZ
{
...
void NvApiSetMemoryOC(int MemoryClockOffset) // Offset MHZ
{
...
//{
//
//	NvApiSetCoreMemoryClockOffset(200, 100);
//	return 0;
//}